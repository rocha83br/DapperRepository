...
namespace Rochas.DapperRepository.Helpers
{
    public static class EntitySqlParser
    {
        ...
        public static void ParseGroupingAttributes(Dictionary<object, object> attributeColumnRelation, string groupAttributes, ref string sqlInstruction)
        {
        ...
        public static void ParseOrdinationAttributes(Dictionary<object, object> attributeColumnRelation, string orderAttributes, bool orderDescending, ref string sqlInstruction)
        {
            string columnList = string.Empty;
